...
import { MessageGroup, Thread, ThreadItem } from '@/lib/types';
...
export type ProviderType = 'openai' | 'anthropic' | 'together' | 'google' | 'fireworks';
...
export const models: Model[] = [
    { id: ModelEnum.GPT_4o_Mini, name: 'GPT-4o Mini', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.GPT_4_1_Mini, name: 'GPT-4.1 Mini', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.GPT_4_1_Nano, name: 'GPT-4.1 Nano', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.GPT_4_1, name: 'GPT-4.1', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.GPT_4o, name: 'GPT-4o', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.O4_Mini, name: 'O4 Mini', provider: 'openai', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.Deepseek_R1_Distill_Qwen_14B, name: 'DeepSeek R1 Distill Qwen 14B', provider: 'together', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.Deepseek_R1, name: 'DeepSeek R1', provider: 'fireworks', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.Claude_3_5_Sonnet, name: 'Claude 3.5 Sonnet', provider: 'anthropic', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.Claude_3_7_Sonnet, name: 'Claude 3.7 Sonnet', provider: 'anthropic', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.GEMINI_2_FLASH, name: 'Gemini 2 Flash', provider: 'google', maxTokens: 200000, contextWindow: 200000 },
    { id: ModelEnum.QWQ_32B, name: 'QWQ 32B', provider: 'fireworks', maxTokens: 16384, contextWindow: 16384 },
    { id: ModelEnum.LLAMA_4_SCOUT, name: 'Llama 4 Scout', provider: 'fireworks', maxTokens: 16384, contextWindow: 16384 },
];
